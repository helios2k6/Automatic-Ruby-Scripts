...
module Constants
	...
	class InputConstants    
		...
		PROG_ARG_VECTOR = [FILE_ARG, DEVICE_ARG, QUALITY_ARG, AVS_ADD_ARG, ENSURE_16_9_ASPECT_RATIO, ENSURE_JAPANESE, NO_MUX_ARG, HELP_ARG, FORCE_AUDIO_TRACK, FORCE_SUBTITLE_TRACK, BLACKLIST_ARG, POST_ENCODING_ARG, NO_SUBS_ARG, NO_AUDIO_ARG, VERY_HIGH_QUALITY_AUDIO_ARG]
