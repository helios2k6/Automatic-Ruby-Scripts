...
module Constants
	...
	class Notifications
		...
		#MOVE FINISHED FILES
		MOVE_FINISHED_FILE = "MOVE_FINISHED_FILE"
	end
	...
	class InputConstants    
		...
		ENCODE_AUDIO_DIRECTLY_ARG = "--encode-audio-directly"
		ENCODE_AUDIO_DIRECTLY_ARG_HELP_STRING = "\t#{ENCODE_AUDIO_DIRECTLY_ARG}\n\t\tEncode the audio directly from the video file using ffaudiosource\n\n"
		...
		[
			...
			HELP_ARG,
			FORCE_AUDIO_TRACK,
			FORCE_SUBTITLE_TRACK,
			BLACKLIST_ARG,
			POST_ENCODING_ARG,
			NO_SUBS_ARG,
			NO_AUDIO_ARG,
			VERY_HIGH_QUALITY_AUDIO_ARG,
			ENCODE_AUDIO_DIRECTLY_ARG
		]
		...
		PROG_ARG_HELP_HASH = {
			...
			ENCODE_AUDIO_DIRECTLY_ARG => ENCODE_AUDIO_DIRECTLY_ARG_HELP_STRING
		}
	end
